        ...
        <div style={{ borderRadius: '5px', margin: 'auto', backgroundColor: '#eee', maxWidth: "420px", height: 'auto' }}>
          ...
          <div>
            ...
            <div style={{ padding: '10px',}}>
              <p style={{ textAlign: 'center', color: '#9800ff' }}>{this.preQuestions[0].question}</p>
                {this.state.show?
                    ...
                    <ul style={{ display: 'block', margin: 'auto', listStyleType: 'none', color: '#9800ff' }}>
                      {
                        this.state.questions[this.state.questionIndex].choices.map((singleChoice) => {
                          return(
                            <li>
                              <input type="radio" checked={ this.state.curChoice === singleChoice } value={ singleChoice } onChange={this.handleChoiceClick}></input>{singleChoice}
                            </li>
                          )
                        })
                      }
