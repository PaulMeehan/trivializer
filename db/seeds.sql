...
insert into owners (ownerName) values 
("Wish You Were Beer"),
("The Tipsy Cow")
;

insert into games (ownerId_fk, questionNumber, questionText, answer1, answer2, answer3, answer4, correctAnswer) values 
(1, 1, "Owner 1, first question", "answer1", "answer2", "answer3", "answer4", "answer1"),
(1, 2, "Owner 1, second question", "answer1", "answer2", "answer3", "answer4", "answer2"),
(1, 3, "Owner 1, third question", "answer1", "answer2", "answer3", "answer4", "answer3"),
(1, 4, "Owner 1, fourth question", "answer1", "answer2", "answer3", "answer4", "answer4"),
(1, 5, "Owner 1, fifth question", "answer1", "answer2", "answer3", "answer4", "answer1"),
(1, 1, "Owner 2, first question", "true", "false", "", "", "true"),
(1, 2, "Owner 2, second question", "true", "false", "", "", "false"),
(1, 3, "Owner 2, third question", "true", "false", "", "", "true"),
(1, 4, "Owner 2, fourth question", "true", "false", "", "", "false"),
(1, 5, "Owner 2, fifth question", "true", "false", "", "", "true")
;

insert into gameresponses (ownerId_fk, questionNumber_fk, teamName, answerGiven, responseOrder, points) values 
